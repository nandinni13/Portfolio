...
.home{
    display: flex;
    background: url("wp7453739.webp") no-repeat center;
    height: 100vh;
    color: rgb(94, 180, 238);
    min-height: 300px;
...
.home .home-content a{
    ...
    font-weight: 400;
    border-radius: 6px;
    border: 2px solid rgb(94, 180, 238);
    transition: all 0.3s ease;
}
...
.skills .skills-content .right a{
    ...
    margin-top: 20px;
    border-radius: 6px;
    border: 2px solidrgb(94, 180, 238);
    transition: all 0.3s ease;
}
...
.teams .carousel .card img{
    ...
    object-fit: cover;
    border-radius: 50%;
    border: 5px solid rgb(94, 180, 238);
    transition: all 0.3s ease;
}
...
.owl-dot{
    ...
    border-radius: 50%;
    border: 2px solid rgb(106, 177, 244)!important;
    transition: all 0.3s ease;
}
.owl-dot.active{
    width: 35px;
...
.owl-dot.active,
.owl-dot:hover{
    background:rgb(94, 180, 238)!important;
}
